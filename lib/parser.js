...
function peg$parse(input, options) {
  ...
  var peg$e43 = peg$otherExpectation("literal");
  var peg$e44 = peg$literalExpectation("i", false);
  var peg$e45 = peg$otherExpectation("string");
  var peg$e46 = peg$literalExpectation("\"", false);
  var peg$e47 = peg$literalExpectation("'", false);
  var peg$e48 = peg$otherExpectation("character class");
  ...
  var peg$f3 = function(name, templateParams, displayName, expression) {
      const result =  {
        type: "rule",
        name: name[0], 
        nameLocation: name[1],
  ...
  var peg$f14 = function(expression, boundaries, delimiter) {
  ...
  var peg$f16 = function(exact) { return [null, exact]; };
  var peg$f17 = function(value) { return { type: "constant", value, location: location() }; };
  var peg$f18 = function(value) { return { type: "variable", value: value[0], location: location() }; };
  ...
  var peg$f21 = function(name, templateArgs) {
  ...
  function peg$parseRule() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      s3 = peg$currPos;
      s4 = peg$parseGenericsArgumentsDeclaration();
      if (s4 !== peg$FAILED) {
        s5 = peg$parse__();
        s3 = s4;
      } else {
  ...
  function peg$parseGenericsArgumentsDeclaration() {
  ...
  function peg$parsetemplateArgs() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s7 !== peg$FAILED) {
          s8 = peg$parse__();
          s9 = peg$parseRuleReferenceExpression();
          if (s9 !== peg$FAILED) {
            s6 = s9;
          } else {
            peg$currPos = s6;
