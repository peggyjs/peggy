...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(what, from) { return {what, from} };
  var peg$f5 = function(from) { return {what: [], from} };
  ...
  var peg$f16 = function(name, displayName, expression) {
      return {
        type: "rule",
        name: name[0],
        nameLocation: name[1],
  ...
  var peg$f18 = function(expression, code) {
      return code !== null
        ? {
            type: "action",
            expression,
  ...
  var peg$f20 = function(pluck, label, expression) {
  ...
  var peg$f21 = function(label, expression) {
      return {
        type: "labeled",
        label: label[0],
  ...
  var peg$f22 = function() { return location(); };
  var peg$f23 = function(label) {
  ...
  var peg$f24 = function(operator, expression) {
      return {
  ...
  var peg$f25 = function(expression, operator) {
      return {
  ...
  var peg$f26 = function(expression, boundaries, delimiter) {
  ...
  var peg$f27 = function(min, max) {
    return [
      min !== null ? min : { type: "constant", value: 0 },
      max !== null ? max : { type: "constant", value: null },
    ];
  };
  var peg$f28 = function(exact) { return [null, exact]; };
  var peg$f29 = function(value) { return { type: "constant", value, location: location() }; };
  var peg$f30 = function(value) { return { type: "variable", value: value[0], location: location() }; };
  ...
  var peg$f34 = function(operator, code) {
      return {
  ...
  var peg$f36 = function(value, ignoreCase) {
      return {
        type: "literal",
        value,
  ...
  var peg$f39 = function(inverted, parts, ignoreCase) {
      return {
        type: "class",
  ...
  var peg$f40 = function(begin, end) {
  ...
  var peg$f51 = function() { return { type: "any", location: location() }; };
  var peg$f52 = function(code) { return [code, location()]; };
  var peg$f53 = function(digits) { return parseInt(digits, 10); };
