...
function peg$parse(input, options) {
  ...
  const peg$e55 = peg$literalExpectation("b", false);
  const peg$e56 = peg$literalExpectation("f", false);
  ...
  const peg$e60 = peg$literalExpectation("v", false);
  const peg$e61 = peg$classExpectation([["0", "9"], "u", "x"], false, false, false);
  const peg$e62 = peg$literalExpectation("x", false);
  const peg$e63 = peg$literalExpectation("u", false);
  ...
  function peg$f55() {    return { type: "any", location: location() };  }
  function peg$f56(code) {    return [code, location()];  }
  function peg$f57(digits) {    return parseInt(digits, 10);  }
