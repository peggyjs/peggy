...
function peg$parse(input, options) {
  ...
  var peg$f36 = function(operator, code) {
      return {
  ...
  var peg$f38 = function(value, ignoreCase) {
      return {
        type: "literal",
        value,
  ...
  var peg$f41 = function(inverted, parts, ignoreCase) {
      return {
        type: "class",
  ...
  var peg$f42 = function(begin, end) {
  ...
  var peg$f53 = function() { return { type: "any", location: location() }; };
  var peg$f54 = function(code) { return [code, location()]; };
  var peg$f55 = function(digits) { return parseInt(digits, 10); };
