...
function peg$parse(input, options) {
  ...
  const peg$e36 = peg$otherExpectation("literal");
  const peg$e37 = peg$literalExpectation("i", false);
  const peg$e38 = peg$otherExpectation("string");
  ...
  const peg$e43 = peg$otherExpectation("character class");
  ...
  const peg$e50 = peg$classExpectation(["\"", "'", "\\"], false, false);
  const peg$e51 = peg$literalExpectation("b", false);
  const peg$e52 = peg$literalExpectation("f", false);
  const peg$e53 = peg$literalExpectation("n", false);
  const peg$e54 = peg$literalExpectation("r", false);
  const peg$e55 = peg$literalExpectation("t", false);
  const peg$e56 = peg$literalExpectation("v", false);
  const peg$e57 = peg$classExpectation([["0", "9"], "u", "x"], false, false);
  const peg$e58 = peg$literalExpectation("x", false);
  const peg$e59 = peg$literalExpectation("u", false);
  const peg$e60 = peg$classExpectation([["0", "9"]], false, false);
  const peg$e61 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true);
  const peg$e62 = peg$otherExpectation("code block");
  const peg$e63 = peg$classExpectation(["{", "}"], false, false);
