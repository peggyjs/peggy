...
function peg$parse(input, options) {
  ...
  const peg$e56 = peg$literalExpectation("b", false);
  const peg$e57 = peg$literalExpectation("f", false);
  const peg$e58 = peg$literalExpectation("n", false);
  const peg$e59 = peg$literalExpectation("r", false);
  const peg$e60 = peg$literalExpectation("t", false);
  const peg$e61 = peg$literalExpectation("v", false);
  const peg$e62 = peg$classExpectation([["0", "9"], "u", "x"], false, false, false);
  const peg$e63 = peg$literalExpectation("x", false);
  const peg$e64 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e65 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true, false);
  const peg$e66 = peg$otherExpectation("code block");
  ...
  function peg$f44() {    return ["ignoreCase", true]  }
  function peg$f45() {    return ["unicode", true]  }
  function peg$f46(begin, end) {
  ...
  function peg$f58() {    return { type: "any", location: location() };  }
  function peg$f59(code) {    return [code, location()];  }
  function peg$f60(digits) {    return parseInt(digits, 10);  }
