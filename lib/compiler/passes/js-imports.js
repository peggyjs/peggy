...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { JSSource: peg$parseJSSource };
  var peg$startRuleFunction = peg$parseJSSource;
  ...
  var peg$f0 = function(imports, code) {
  return [imports, {
  ...
  var peg$f3 = function(topLevelInitializer, initializer, rules) {
      return {
        type: "grammar",
        topLevelInitializer,
        initializer,
  ...
  var peg$f6 = function(name, displayName, expression) {
      return {
        type: "rule",
        name: name[0],
        nameLocation: name[1],
  ...
  var peg$f8 = function(expression, code) {
      return code !== null
        ? {
            type: "action",
            expression,
  ...
  var peg$f10 = function(pluck, label, expression) {
  ...
  var peg$f11 = function(label, expression) {
      return {
        type: "labeled",
        label: label[0],
  ...
  var peg$f12 = function() { return location(); };
  var peg$f13 = function(label) {
  ...
  var peg$f14 = function(operator, expression) {
      return {
  ...
  var peg$f15 = function(expression, operator) {
      return {
  ...
  var peg$f16 = function(expression, boundaries, delimiter) {
  ...
  var peg$f18 = function(exact) { return [null, exact]; };
  var peg$f19 = function(value) { return { type: "constant", value, location: location() }; };
  var peg$f20 = function(value) { return { type: "variable", value: value[0], location: location() }; };
  ...
  var peg$f24 = function(operator, code) {
      return {
