...
function toSourceNode(code, location, name) {
  const start = (location.source && (typeof location.source.offset === "function"))
    ? location.source.offset(location.start)
    : location.start;
...
function wrapInSourceNode(prefix, chunk, location, suffix, name) {
  ...
  if (location) {
    const end = (location.source && (typeof location.source.offset === "function"))
      ? location.source.offset(location.end)
      : location.end;
