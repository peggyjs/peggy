...
class Intern {
   ...
   *   stored form.  Required if type V is not the same as type T.
   */
  ...
  /**
   * Intern an item, getting it's asssociated number.  O(1) with constants
   * tied to the convert and stringify options.
   *
   * @param {T} input
   * @return {number}
   */
