...
function peg$parse(input, options) {
  ...
  const peg$e11 = peg$literalExpectation("bar", true);
  const peg$e12 = peg$literalExpectation(" ", false);
  const peg$e13 = peg$literalExpectation("c", false);
  const peg$e14 = peg$classExpectation([["a", "c"]], false, false, false);
  ...
  function peg$f16(num) {    return parseInt(num, 10) < 100  }
  ...
  function peg$f20(match, rest) {    return {match, rest};  }
  function peg$f21(foo) {    return {foo};  }
  function peg$f22(match, rest) {    return {match, rest};  }
  function peg$f23(match, rest) {    return {match, rest};  }
  function peg$f24(two) {    return two.length < 3  }
  function peg$f25(match, rest) {    return {match, rest};  }
  function peg$f26(match, rest) {    return {match, rest};  }
  function peg$f27() {    return location();  }
...
function peg$getUnicode(pos = peg$currPos) {
  ...
  root.peggyExamples = {
    StartRules: ["literal", "literal_i", "any", "class", "not_class_i", "not_class_u", "rule", "child", "paren", "paren_pluck", "star", "plus", "repetition", "maybe", "posAssertion", "negAssertion", "posPredicate", "negPredicate", "dollar", "label", "pluck_1", "pluck_2", "sequence", "action", "alt", "no_input", "end_of_input", "rest"],
